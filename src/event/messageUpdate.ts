...
export const main = async (
  ...
  try {
    ...
    const embeds = logEmbed({
      ...
      fields: [
        {
          name: t(lang, "embeds.logs.message.update.fields.user"),
          value: `<@${newMessage.author.id}>`,
          inline: true,
        },
        {
          name: t(lang, "embeds.logs.message.update.fields.channel"),
          value: `<#${newMessage.channel.id}>`,
          inline: true,
        },
        {
          name: t(lang, "embeds.logs.message.update.fields.link"),
          value: `[Jump](${newMessage.url})`,
          inline: false,
        },
        {
          name: t(lang, "embeds.logs.message.update.fields.before"),
          value: formatContent(oldMessage),
          inline: false,
        },
        {
          name: t(lang, "embeds.logs.message.update.fields.after"),
